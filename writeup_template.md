...
I normalized the image data because to remove any unnecesary deviations the netowrk to learn
...
| Flatten		| Outputs 400
| Convolution 3x3	    | 1x1 stride, output 10x10x6
...
* How does the final model's accuracy on the training, validation and test set provide evidence that the model is working well?
 The accurcy is acheived to be ~90% which is a good starting point for classifcation of the traffic signs
